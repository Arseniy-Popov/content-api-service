...
@router.get("/", response_model=PaginatedResponse[FilmShortSchema])
...
@router.get("/search", response_model=PaginatedResponse[FilmShortSchema])
...
@router.get("/{film_id}", response_model=FilmLongSchema)
